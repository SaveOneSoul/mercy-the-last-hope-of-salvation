...
else if(theme==='jesus'){halo(ctx,540,200,156);heart(ctx,540,217,1.85);cross(ctx,540,124,.35);ctx.strokeStyle='#edc778';ctx.lineWidth=7;ctx.beginPath();ctx.arc(540,225,88,-.2,Math.PI+ .2);ctx.stroke();}
else if(theme==='mercy'){halo(ctx,540,142,93);ellipse(ctx,540,140,72,82,'#fff4dd');for(var k=0;k<11;k++){line(ctx,530+k*4,205,210+k*18,434,'#f1d7df',5);line(ctx,545+k*4,205,640+k*20,434,'#b6d6f5',5);}heart(ctx,540,205,.85);}
